...
const MusicVisualizer = () => {
  return (
    <div className="flex justify-center items-center mt-32 h-[130px] absolute top-0 w-full z-10">
      <div className="w-[15px] h-full mx-[15px] bg-gradient-to-b from-orange-800 via-orange-500 to-orange-300 animate-dance1"></div>
      <div className="w-[10px] h-full mx-[5px] bg-gradient-to-b from-orange-800 via-orange-500 to-orange-300 animate-dance2"></div>
      <div className="w-[10px] h-full mx-[5px] bg-gradient-to-b from-orange-800 via-orange-500 to-orange-300 animate-dance3"></div>
      <div className="w-[10px] h-full mx-[5px] bg-gradient-to-b from-orange-800 via-orange-500 to-orange-300 animate-dance4"></div>
      <div className="w-[10px] h-full mx-[5px] bg-gradient-to-b from-orange-800 via-orange-500 to-orange-300 animate-dance5"></div>
      <div className="w-[10px] h-full mx-[5px] bg-gradient-to-b from-orange-800 via-orange-500 to-orange-300 animate-dance3"></div>
