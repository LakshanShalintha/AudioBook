...
function BiographiesMemories() {
  ...
  const fetchPdfs = async () => {
    ...
    const folderRef = ref(storage, 'gs://audirab-44b07.appspot.com/Categories/Biographies & Memories');
  ...
  return (
    <div className="bg-gray-900 min-h-screen text-white flex flex-col">
      ...
      {/* Page title */}
      <h1 className="text-center text-4xl mt-8 font-bold ">Biographies & Memories</h1>
