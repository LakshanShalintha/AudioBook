...
function PersonalGrowth() {
  ...
  const fetchPdfs = async () => {
    ...
    const folderRef = ref(storage, 'gs://audirab-44b07.appspot.com/Categories/Personal Growth');
  ...
  return (
    <div className="bg-gray-900 min-h-screen text-white flex flex-col">
      ...
      {/* Page title */}
      <h1 className="text-center text-4xl mt-8 font-bold">Personal Growth</h1>
